       ...
       return (
           <>
                ...
                <div className="row">
                    ...
                    <Text> Once the IDO sale has been concluded, the platform will prepare the tokens for release. Once the necessary preparations are done, participants can now proceed with claiming. Just click the Claim buttons designated for the first and second rounds of the sale found on the same page where the sale was conducted. Participants may choose to participate in the Liquidity Staking options that will be launched after the sale to earn extra token rewards. </Text>
                </div>
            </>
       )
};
