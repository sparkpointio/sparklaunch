...
import { ActionsDiv, StyledContainer, StyledDiv, StyledHeader, StyledLink } from './styled';
...
const Section: React.FC = () => {
    ...
    return (
        <StyledContainer>
            ...
            <StyledDiv style={{ justifyContent: 'center', textAlign: 'center' }}>
                <h5>Exclusively on <img src={exclusive_binance} alt='ex-binance' width='20vw' height='20vh'
                                        style={{ verticalAlign: 'middle' }} /> Binance Smart Chain</h5>
            </StyledDiv>
